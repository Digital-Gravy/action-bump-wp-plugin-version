...
// dist/versionBumper.js
var require_versionBumper = __commonJS({
  "dist/versionBumper.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.PrereleaseTypes = exports2.BumpTypes = exports2.defaultFileSystem = void 0;
    exports2.bumpVersion = bumpVersion;
    var fs_1 = __importDefault(require("fs"));
    exports2.defaultFileSystem = {
      readFileSync: (path6) => fs_1.default.readFileSync(path6, "utf8"),
      writeFileSync: (path6, data) => fs_1.default.writeFileSync(path6, data, "utf8"),
      existsSync: (path6) => fs_1.default.existsSync(path6)
    };
    exports2.BumpTypes = {
      MAJOR: "major",
      MINOR: "minor",
    ...
    function getPrereleaseOrder(type) {
      const order = {
        [exports2.PrereleaseTypes.NONE]: -1,
        [exports2.PrereleaseTypes.DEV]: 0,
        [exports2.PrereleaseTypes.ALPHA]: 1,
        [exports2.PrereleaseTypes.BETA]: 2,
        [exports2.PrereleaseTypes.RC]: 3
      };
      return order[type] || -1;
    }
    function updateSureCartReleaseFile(filePath, newVersion, fileSystem = exports2.defaultFileSystem) {
    ...
    function bumpVersion(pluginFilePath, bumpType, prereleaseType, sureCartReleaseFilePath, fileSystem = exports2.defaultFileSystem) {
      if (!Object.values(exports2.BumpTypes).includes(bumpType)) {
        throw new Error(`Invalid bump type: ${bumpType}`);
      }
      if (!Object.values(exports2.PrereleaseTypes).includes(prereleaseType)) {
      ...
      switch (bumpType) {
        case exports2.BumpTypes.MAJOR:
          versionObj.major++;
          versionObj.minor = 0;
          versionObj.patch = 0;
          break;
        case exports2.BumpTypes.MINOR:
          versionObj.minor++;
          versionObj.patch = 0;
          break;
        case exports2.BumpTypes.PATCH:
          versionObj.patch++;
          break;
        case exports2.BumpTypes.BUILD:
          versionObj.build = (/* @__PURE__ */ new Date()).toISOString().replace(/[-:]/g, "").replace(/\.\d{3}Z$/, "").replace("T", "");
          break;
        case exports2.BumpTypes.STABLE:
          versionObj.prereleaseType = null;
          versionObj.prereleaseNum = null;
          versionObj.build = null;
          break;
      }
      if (prereleaseType !== exports2.PrereleaseTypes.NONE) {
        if (versionObj.prereleaseType && getPrereleaseOrder(prereleaseType) < getPrereleaseOrder(versionObj.prereleaseType)) {
          throw new Error("Prerelease downgrade is not allowed");
        }
        versionObj.prereleaseNum = versionObj.prereleaseType === prereleaseType && versionObj.prereleaseNum ? versionObj.prereleaseNum + 1 : 1;
      ...
      if (isVersionBumped) {
        ...
        fileContents = fileContents.slice(0, index) + match.replace(currentVersion, newVersion) + fileContents.slice(index + match.length);
...
var core = __importStar((init_core(), __toCommonJS(core_exports)));
var versionBumper_1 = require_versionBumper();
Object.defineProperty(exports, "bumpVersion", { enumerable: true, get: function() {
  return versionBumper_1.bumpVersion;
} });
function run() {
  try {
    ...
    const sureCartReleaseFilePath = sureCartReleaseFile ? `${pluginDir}/${sureCartReleaseFile}` : void 0;
